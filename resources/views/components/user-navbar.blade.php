<nav class="flex bg-yellow-100 shadow-md px-15 py-3 justify-between items-center">
    <div>
        <a href="/" class="text-green-900"><h1 class="text-2xl font-bold">Quiz System</h1></a>
    </div>
    <div class="space-x-3">
